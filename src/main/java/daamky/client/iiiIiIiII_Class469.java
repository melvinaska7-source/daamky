...
public class iiiIiIiII_Class469 extends iiiIiIIII_Class465 {
   ...
   public iiiIiIiII_Class469(iiiIIiIIi_Class458 var1, iiiIIiIIi_Class458 var2) {
      super(var1, var2);
   }
   ...
   public boolean I_method_a7f2ac8b(iiiIIIiIi_Class454 var1) {
      if (Math.abs(this.i_field_fa2e3e6c.I_method_6d204e12() - this.I_field_fa2e3e6c.I_method_6d204e12())
         ...
         if (var4 == 0) {
            ...
            this.ii_field_44 = 1.0 + var10 * 1.5 + var4 * 0.4;
            return true;
         }
      }
   }
      ...
      if (var2 != null && var1.world != null && var1.interactionManager != null) {
         ...
         if (var4 == null) {
            ...
            if (var12 > 1.7) {
               ...
               Direction var13 = I_method_220ee57c(var2, var4);
   ...
   private iiiIiIIII_Class465.Nested1_33b738a0 i_method_1acc8fd0() {
      MinecraftClient var1 = MinecraftClient.getInstance();
      ClientPlayerEntity var2 = var1.player;
      if (var2 == null) {
         return iiiIiIIII_Class465.Nested1_33b738a0.II_field_86e7b1e7;
      } else if (this.i_method_af4d9243(0.4) && Math.abs(var2.getY() - this.i_field_fa2e3e6c.i_method_6d2ed9f2()) < 1.0 && var2.isOnGround()) {
         return iiiIiIIII_Class465.Nested1_33b738a0.i_field_86e7b1e7;
      } else {
   ...
   private static Direction I_method_220ee57c(ClientPlayerEntity var0, BlockPos var1) {
