...
public class iIiiIiii_Class184
extends iIiIIIii_Class164 {
    public iIiiIiii_Class184() {
        super("modules.settings.assist.radiation_potion", Items.SPLASH_POTION.getDefaultStack(), iIIiIIii_Class148.II_field_88b781);
    }
