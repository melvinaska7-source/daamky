...
import daamky.client.IIiiIIIII_Class97;
...
public class IIiiIIIIi_Class98
extends IIiIiiiiI_Class95 {
    private final IIiiIIIII_Class97 I_field_8376ae8c;
    private final String I_field_523beb0a;
    private final String i_field_523beb0a;

    public IIiiIIIIi_Class98(IIiiIIIII_Class97 iModuleInfo, String string, String string2) {
        super(2500L);
        this.I_field_8376ae8c = iModuleInfo;
    ...
    public final void I_method_df9d7d83(CustomDrawContext customDrawContext, float f) {
        ...
        customDrawContext.drawIcon(this.I_field_8376ae8c.I_method_e6beac41(), f4 + f6 / 2.0f - 4.5f, f5 + f6 / 2.0f - 4.5f, 10.0f, this.I_field_8376ae8c.i_method_9acd648e().withAlpha((float)n * 0.8f));
