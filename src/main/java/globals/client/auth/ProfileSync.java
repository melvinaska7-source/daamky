...
import daamky.client.IiIIIIII_Class65;
...
public final class ProfileSync {
    ...
    private static void apply(JsonObject jsonObject) {
        ...
        Profile.avatarUrl = string3 == null || string3.startsWith("http") ? string3 : "https://daamky.pub" + string3;
    ...
    private static void republish() {
        ...
        try {
            IiIIIIII_Class65 iiIIIIII_Class65 = DaamkyClient.getInstance().I_method_78894eeb();
            if (iiIIIIII_Class65 != null) {
                iiIIIIII_Class65.I_method_2bd9f0ac();
            }
        }
        catch (Exception exception) {
