...
public class ColorRGBA {
    ...
    public ColorRGBA mix(ColorRGBA colorRGBA, float f) {
        ...
        return new ColorRGBA(iIIiiiiiI_Class319.I_method_5f7ff5cf(this.getRed(), colorRGBA.getRed(), f), iIIiiiiiI_Class319.I_method_5f7ff5cf(this.getGreen(), colorRGBA.getGreen(), f), iIIiiiiiI_Class319.I_method_5f7ff5cf(this.getBlue(), colorRGBA.getBlue(), f), iIIiiiiiI_Class319.I_method_5f7ff5cf(this.getAlpha(), colorRGBA.getAlpha(), f));
    }
